  ...
  */}
  ...
  async mintTokens(amount: number): Promise<void>
  {
    try {
      ...
      toast.success(<>
        Congratulations, you have succesfully minted!<br />
              ...
              <>
                ...
                {!this.isSoldOut() ?
                  ...
                  <div className="collection-sold-out">
                    <h2>MORTHIR has <strong>sold out</strong>!</h2>

                    Secondary is available at <a href={this.generateMarketplaceUrl()} target="_blank">{CollectionConfig.marketplaceConfig.name}</a>.
                  </div>
                }
              </>
              :
...
{/*
  ...
  private async initWallet(): Promise<void>
  {
    ...
    if (await this.provider.getCode(CollectionConfig.contractAddress!) === '0x') {
      this.setError('Are you connected to the mainnet?');
